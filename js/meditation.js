...
function openMindInfo(type){
    ...
    function persistGratitudeEntries(source='gratitude'){localStorage.setItem('thalys_gratitude',JSON.stringify(appState.gratitude||[]));saveStateToLocal({source});scheduleAutosave?.();}
