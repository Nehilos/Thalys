(function () {
  ...
  async function initialize() {
    ...
    await put(CONFIG.stores.meta, { key: 'versions', value: { appVersion: '0.37.1', dbVersion: CONFIG.dbVersion, schemaVersion: CONFIG.schemaVersion, syncProtocolVersion: CONFIG.syncProtocolVersion }, updatedAt: now });
