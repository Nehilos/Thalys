(function () {
  ...
  async function writePrimaryState(state, meta = {}) {
    ...
    const record = {
      ...
      appVersion: (window.ThalysConfig?.appVersion || '0.40.0')
    };
    try {
  ...
  async function initialize() {
    ...
    await put(CONFIG.stores.meta, { key: 'versions', value: { appVersion: (window.ThalysConfig?.appVersion || '0.40.0'), dbVersion: CONFIG.dbVersion, schemaVersion: CONFIG.schemaVersion, syncProtocolVersion: CONFIG.syncProtocolVersion }, updatedAt: now });
