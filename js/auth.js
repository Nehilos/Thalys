// Thalys v0.49.4 - Authentication and persistent session module
...
const GYM_CLIENT_ID = '530515970912-7mlo4stsbcbcajrov07f911se4upv8t2.apps.googleusercontent.com';
    ...
    const THALYS_SOFTWARE_VERSION = window.ThalysConfig?.appVersion || '0.49.4';
    ...
    async function connectDriveAfterToken(silent=false,retryCount=0){
      ...
      try{
        ...
        // v0.49.4: never declare reconnect complete while a persisted dirty flag or
