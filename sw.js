const CACHE_NAME = 'thalys-shell-v0.54.2';
...
const APP_SHELL = [
  ...
  './css/thalys.css?v=0542',
  './js/tailwind-config.js?v=015',
  './js/theme-bootstrap.js?v=015',
  './js/config.js?v=0542',
  './js/capabilities.js?v=0542',
  './js/device-media.js?v=0542',
  './js/backend-bridge.js?v=0542',
  './js/server-auth.js?v=0542',
  './js/notifications.js?v=0542',
  './js/storage-manager.js?v=0542',
  './js/sync-queue.js?v=0542',
  './js/conflict-resolver.js?v=0542',
  './js/local-db.js?v=0542',
  './js/ui-foundation.js?v=0542',
  './js/language.js?v=0542',
  './js/drive.js?v=0542',
  './js/auth.js?v=0542',
  './js/app-core.js?v=0542',
  './js/body.js?v=0542',
  './js/meditation.js?v=0542',
  './js/nutrition.js?v=0542',
  './js/workout.js?v=0542',
  './js/home.js?v=0542',
  './js/analytics.js?v=0542',
  './js/oauth-ui.js?v=015',
  './js/media-tools.js?v=025',
  './js/pwa-register.js?v=015',
  './js/app-enhancements.js?v=0542',
  './js/runtime-health.js?v=0542',
