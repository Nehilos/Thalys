const CACHE_NAME = 'thalys-shell-v0.30';
...
const APP_SHELL = [
  ...
  './js/local-db.js?v=030',
  './js/ui-foundation.js?v=030',
  './js/language.js?v=030',
  './js/drive.js?v=030',
  './js/auth.js?v=030',
  './js/app-core.js?v=030',
  './js/body.js?v=030',
  './js/meditation.js?v=030',
  './js/nutrition.js?v=030',
  './js/workout.js?v=030',
  './js/oauth-ui.js?v=015',
  './js/media-tools.js?v=025',
  './js/pwa-register.js?v=015',
  './js/app-enhancements.js?v=030',
