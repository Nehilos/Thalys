const CACHE_NAME = 'thalys-shell-v0.48.1';
...
const APP_SHELL = [
  ...
  './js/config.js?v=0481',
  './js/capabilities.js?v=0481',
  './js/device-media.js?v=0481',
  './js/backend-bridge.js?v=0481',
  './js/server-auth.js?v=0481',
  './js/notifications.js?v=0481',
  './js/storage-manager.js?v=0481',
  './js/sync-queue.js?v=0481',
  './js/conflict-resolver.js?v=0481',
  './js/local-db.js?v=0481',
  './js/ui-foundation.js?v=0481',
  './js/language.js?v=0481',
  './js/drive.js?v=0481',
  './js/auth.js?v=0481',
  './js/app-core.js?v=0481',
  './js/body.js?v=0481',
  './js/meditation.js?v=0481',
  './js/nutrition.js?v=0481',
  './js/workout.js?v=0481',
  './js/home.js?v=0481',
  './js/analytics.js?v=0481',
  './js/oauth-ui.js?v=015',
  './js/media-tools.js?v=025',
  './js/pwa-register.js?v=015',
  './js/app-enhancements.js?v=0481',
  './js/runtime-health.js?v=0481',
...
// v0.48.1 - notification/push client foundation. Remote push delivery requires a server subscription endpoint.
