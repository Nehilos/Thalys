const CACHE_NAME = 'thalys-shell-v0.29';
...
const APP_SHELL = [
  ...
  './js/local-db.js?v=029',
  './js/ui-foundation.js?v=029',
  './js/language.js?v=029',
  './js/drive.js?v=029',
  './js/auth.js?v=029',
  './js/app-core.js?v=029',
  './js/body.js?v=029',
  './js/meditation.js?v=029',
  './js/nutrition.js?v=029',
  './js/oauth-ui.js?v=015',
  './js/media-tools.js?v=025',
  './js/pwa-register.js?v=015',
  './js/app-enhancements.js?v=029',
