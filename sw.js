const CACHE_NAME = 'thalys-shell-v0.50.1';
...
const APP_SHELL = [
  ...
  './css/thalys.css?v=0501',
  './js/tailwind-config.js?v=015',
  './js/theme-bootstrap.js?v=015',
  './js/config.js?v=0501',
  './js/capabilities.js?v=0501',
  './js/device-media.js?v=0501',
  './js/backend-bridge.js?v=0501',
  './js/server-auth.js?v=0501',
  './js/notifications.js?v=0501',
  './js/storage-manager.js?v=0501',
  './js/sync-queue.js?v=0501',
  './js/conflict-resolver.js?v=0501',
  './js/local-db.js?v=0501',
  './js/ui-foundation.js?v=0501',
  './js/language.js?v=0501',
  './js/drive.js?v=0501',
  './js/auth.js?v=0501',
  './js/app-core.js?v=0501',
  './js/body.js?v=0501',
  './js/meditation.js?v=0501',
  './js/nutrition.js?v=0501',
  './js/workout.js?v=0501',
  './js/home.js?v=0501',
  './js/analytics.js?v=0501',
  './js/oauth-ui.js?v=015',
  './js/media-tools.js?v=025',
  './js/pwa-register.js?v=015',
  './js/app-enhancements.js?v=0501',
  './js/runtime-health.js?v=0501',
