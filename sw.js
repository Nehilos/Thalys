const CACHE_NAME = 'thalys-shell-v0.37';
...
const APP_SHELL = [
  ...
  './js/storage-manager.js?v=037',
  './js/sync-queue.js?v=037',
  './js/conflict-resolver.js?v=037',
  './js/local-db.js?v=037',
  './js/ui-foundation.js?v=037',
  './js/language.js?v=037',
  './js/drive.js?v=037',
  './js/auth.js?v=037',
  './js/app-core.js?v=037',
  './js/body.js?v=037',
  './js/meditation.js?v=037',
  './js/nutrition.js?v=037',
  './js/workout.js?v=037',
  './js/home.js?v=037',
  './js/analytics.js?v=037',
  './js/oauth-ui.js?v=015',
  './js/media-tools.js?v=025',
  './js/pwa-register.js?v=015',
  './js/app-enhancements.js?v=037',
