const CACHE_NAME = 'thalys-shell-v0.36.2';
...
const APP_SHELL = [
  ...
  './js/storage-manager.js?v=0362',
  './js/sync-queue.js?v=0362',
  './js/conflict-resolver.js?v=0362',
  './js/local-db.js?v=0362',
  './js/ui-foundation.js?v=0362',
  './js/language.js?v=0362',
  './js/drive.js?v=0362',
  './js/auth.js?v=0362',
  './js/app-core.js?v=0362',
  './js/body.js?v=0362',
  './js/meditation.js?v=0362',
  './js/nutrition.js?v=0362',
  './js/workout.js?v=0362',
  './js/home.js?v=0362',
  './js/analytics.js?v=0362',
  './js/oauth-ui.js?v=015',
  './js/media-tools.js?v=025',
  './js/pwa-register.js?v=015',
  './js/app-enhancements.js?v=0362',
