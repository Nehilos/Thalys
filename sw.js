const CACHE_NAME = 'thalys-shell-v0.48.2';
...
const APP_SHELL = [
  ...
  './js/config.js?v=0482',
  './js/capabilities.js?v=0482',
  './js/device-media.js?v=0482',
  './js/backend-bridge.js?v=0482',
  './js/server-auth.js?v=0482',
  './js/notifications.js?v=0482',
  './js/storage-manager.js?v=0482',
  './js/sync-queue.js?v=0482',
  './js/conflict-resolver.js?v=0482',
  './js/local-db.js?v=0482',
  './js/ui-foundation.js?v=0482',
  './js/language.js?v=0482',
  './js/drive.js?v=0482',
  './js/auth.js?v=0482',
  './js/app-core.js?v=0482',
  './js/body.js?v=0482',
  './js/meditation.js?v=0482',
  './js/nutrition.js?v=0482',
  './js/workout.js?v=0482',
  './js/home.js?v=0482',
  './js/analytics.js?v=0482',
  './js/oauth-ui.js?v=015',
  './js/media-tools.js?v=025',
  './js/pwa-register.js?v=015',
  './js/app-enhancements.js?v=0482',
  './js/runtime-health.js?v=0482',
