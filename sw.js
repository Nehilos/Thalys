const CACHE_NAME = 'thalys-shell-v0.38.0';
...
const APP_SHELL = [
  ...
  './js/config.js?v=0380',
  './js/capabilities.js?v=0380',
  './js/storage-manager.js?v=0380',
  './js/sync-queue.js?v=0380',
  './js/conflict-resolver.js?v=0380',
  './js/local-db.js?v=0380',
  './js/ui-foundation.js?v=0380',
  './js/language.js?v=0380',
  './js/drive.js?v=0380',
  './js/auth.js?v=0380',
  './js/app-core.js?v=0380',
  './js/body.js?v=0380',
  './js/meditation.js?v=0380',
  './js/nutrition.js?v=0380',
  './js/workout.js?v=0380',
  './js/home.js?v=0380',
  './js/analytics.js?v=0380',
  './js/oauth-ui.js?v=015',
  './js/media-tools.js?v=025',
  './js/pwa-register.js?v=015',
  './js/app-enhancements.js?v=0380',
  './js/runtime-health.js?v=0380',
