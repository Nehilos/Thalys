const CACHE_NAME = 'thalys-shell-v0.36';
...
const APP_SHELL = [
  ...
  './js/storage-manager.js?v=036',
  './js/sync-queue.js?v=036',
  './js/conflict-resolver.js?v=036',
  './js/local-db.js?v=036',
  './js/ui-foundation.js?v=036',
  './js/language.js?v=036',
  './js/drive.js?v=036',
  './js/auth.js?v=036',
  './js/app-core.js?v=036',
  './js/body.js?v=036',
  './js/meditation.js?v=036',
  './js/nutrition.js?v=036',
  './js/workout.js?v=036',
  './js/home.js?v=036',
  './js/analytics.js?v=036',
  './js/oauth-ui.js?v=015',
  './js/media-tools.js?v=025',
  './js/pwa-register.js?v=015',
  './js/app-enhancements.js?v=036',
