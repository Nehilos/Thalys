const CACHE_NAME = 'thalys-shell-v0.53.0';
...
const APP_SHELL = [
  ...
  './css/thalys.css?v=0530',
  './js/tailwind-config.js?v=015',
  './js/theme-bootstrap.js?v=015',
  './js/config.js?v=0530',
  './js/capabilities.js?v=0530',
  './js/device-media.js?v=0530',
  './js/backend-bridge.js?v=0530',
  './js/server-auth.js?v=0530',
  './js/notifications.js?v=0530',
  './js/storage-manager.js?v=0530',
  './js/sync-queue.js?v=0530',
  './js/conflict-resolver.js?v=0530',
  './js/local-db.js?v=0530',
  './js/ui-foundation.js?v=0530',
  './js/language.js?v=0530',
  './js/drive.js?v=0530',
  './js/auth.js?v=0530',
  './js/app-core.js?v=0530',
  './js/body.js?v=0530',
  './js/meditation.js?v=0530',
  './js/nutrition.js?v=0530',
  './js/workout.js?v=0530',
  './js/home.js?v=0530',
  './js/analytics.js?v=0530',
  './js/oauth-ui.js?v=015',
  './js/media-tools.js?v=025',
  './js/pwa-register.js?v=015',
  './js/app-enhancements.js?v=0530',
  './js/runtime-health.js?v=0530',
