const CACHE_NAME = 'thalys-shell-v0.50.2';
...
const APP_SHELL = [
  ...
  './css/thalys.css?v=0502',
  './js/tailwind-config.js?v=015',
  './js/theme-bootstrap.js?v=015',
  './js/config.js?v=0502',
  './js/capabilities.js?v=0502',
  './js/device-media.js?v=0502',
  './js/backend-bridge.js?v=0502',
  './js/server-auth.js?v=0502',
  './js/notifications.js?v=0502',
  './js/storage-manager.js?v=0502',
  './js/sync-queue.js?v=0502',
  './js/conflict-resolver.js?v=0502',
  './js/local-db.js?v=0502',
  './js/ui-foundation.js?v=0502',
  './js/language.js?v=0502',
  './js/drive.js?v=0502',
  './js/auth.js?v=0502',
  './js/app-core.js?v=0502',
  './js/body.js?v=0502',
  './js/meditation.js?v=0502',
  './js/nutrition.js?v=0502',
  './js/workout.js?v=0502',
  './js/home.js?v=0502',
  './js/analytics.js?v=0502',
  './js/oauth-ui.js?v=015',
  './js/media-tools.js?v=025',
  './js/pwa-register.js?v=015',
  './js/app-enhancements.js?v=0502',
  './js/runtime-health.js?v=0502',
