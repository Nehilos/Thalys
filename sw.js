const CACHE_NAME = 'thalys-shell-v0.48.5';
...
const APP_SHELL = [
  ...
  './js/config.js?v=0485',
  './js/capabilities.js?v=0485',
  './js/device-media.js?v=0485',
  './js/backend-bridge.js?v=0485',
  './js/server-auth.js?v=0485',
  './js/notifications.js?v=0485',
  './js/storage-manager.js?v=0485',
  './js/sync-queue.js?v=0485',
  './js/conflict-resolver.js?v=0485',
  './js/local-db.js?v=0485',
  './js/ui-foundation.js?v=0485',
  './js/language.js?v=0485',
  './js/drive.js?v=0485',
  './js/auth.js?v=0485',
  './js/app-core.js?v=0485',
  './js/body.js?v=0485',
  './js/meditation.js?v=0485',
  './js/nutrition.js?v=0485',
  './js/workout.js?v=0485',
  './js/home.js?v=0485',
  './js/analytics.js?v=0485',
  './js/oauth-ui.js?v=015',
  './js/media-tools.js?v=025',
  './js/pwa-register.js?v=015',
  './js/app-enhancements.js?v=0485',
  './js/runtime-health.js?v=0485',
