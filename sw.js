const CACHE_NAME = 'thalys-shell-v0.48.4';
...
const APP_SHELL = [
  ...
  './js/config.js?v=0484',
  './js/capabilities.js?v=0484',
  './js/device-media.js?v=0484',
  './js/backend-bridge.js?v=0484',
  './js/server-auth.js?v=0484',
  './js/notifications.js?v=0484',
  './js/storage-manager.js?v=0484',
  './js/sync-queue.js?v=0484',
  './js/conflict-resolver.js?v=0484',
  './js/local-db.js?v=0484',
  './js/ui-foundation.js?v=0484',
  './js/language.js?v=0484',
  './js/drive.js?v=0484',
  './js/auth.js?v=0484',
  './js/app-core.js?v=0484',
  './js/body.js?v=0484',
  './js/meditation.js?v=0484',
  './js/nutrition.js?v=0484',
  './js/workout.js?v=0484',
  './js/home.js?v=0484',
  './js/analytics.js?v=0484',
  './js/oauth-ui.js?v=015',
  './js/media-tools.js?v=025',
  './js/pwa-register.js?v=015',
  './js/app-enhancements.js?v=0484',
  './js/runtime-health.js?v=0484',
