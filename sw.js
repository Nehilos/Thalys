const CACHE_NAME = 'thalys-shell-v0.35';
...
const APP_SHELL = [
  ...
  './js/storage-manager.js?v=035',
  './js/sync-queue.js?v=035',
  './js/conflict-resolver.js?v=035',
  './js/local-db.js?v=035',
  './js/ui-foundation.js?v=035',
  './js/language.js?v=035',
  './js/drive.js?v=035',
  './js/auth.js?v=035',
  './js/app-core.js?v=035',
  './js/body.js?v=035',
  './js/meditation.js?v=035',
  './js/nutrition.js?v=035',
  './js/workout.js?v=035',
  './js/home.js?v=035',
  './js/analytics.js?v=035',
  './js/oauth-ui.js?v=015',
  './js/media-tools.js?v=025',
  './js/pwa-register.js?v=015',
  './js/app-enhancements.js?v=035',
