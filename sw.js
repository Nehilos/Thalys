const CACHE_NAME = 'thalys-shell-v0.48.6';
...
const APP_SHELL = [
  ...
  './js/config.js?v=0486',
  './js/capabilities.js?v=0486',
  './js/device-media.js?v=0486',
  './js/backend-bridge.js?v=0486',
  './js/server-auth.js?v=0486',
  './js/notifications.js?v=0486',
  './js/storage-manager.js?v=0486',
  './js/sync-queue.js?v=0486',
  './js/conflict-resolver.js?v=0486',
  './js/local-db.js?v=0486',
  './js/ui-foundation.js?v=0486',
  './js/language.js?v=0486',
  './js/drive.js?v=0486',
  './js/auth.js?v=0486',
  './js/app-core.js?v=0486',
  './js/body.js?v=0486',
  './js/meditation.js?v=0486',
  './js/nutrition.js?v=0486',
  './js/workout.js?v=0486',
  './js/home.js?v=0486',
  './js/analytics.js?v=0486',
  './js/oauth-ui.js?v=015',
  './js/media-tools.js?v=025',
  './js/pwa-register.js?v=015',
  './js/app-enhancements.js?v=0486',
  './js/runtime-health.js?v=0486',
