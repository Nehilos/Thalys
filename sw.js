const CACHE_NAME = 'thalys-shell-v0.50.0';
...
const APP_SHELL = [
  ...
  './js/config.js?v=0500',
  './js/capabilities.js?v=0500',
  './js/device-media.js?v=0500',
  './js/backend-bridge.js?v=0500',
  './js/server-auth.js?v=0500',
  './js/notifications.js?v=0500',
  './js/storage-manager.js?v=0500',
  './js/sync-queue.js?v=0500',
  './js/conflict-resolver.js?v=0500',
  './js/local-db.js?v=0500',
  './js/ui-foundation.js?v=0500',
  './js/language.js?v=0500',
  './js/drive.js?v=0500',
  './js/auth.js?v=0500',
  './js/app-core.js?v=0500',
  './js/body.js?v=0500',
  './js/meditation.js?v=0500',
  './js/nutrition.js?v=0500',
  './js/workout.js?v=0500',
  './js/home.js?v=0500',
  './js/analytics.js?v=0500',
  './js/oauth-ui.js?v=015',
  './js/media-tools.js?v=025',
  './js/pwa-register.js?v=015',
  './js/app-enhancements.js?v=0500',
  './js/runtime-health.js?v=0500',
