const CACHE_NAME = 'thalys-shell-v0.52.0';
...
const APP_SHELL = [
  ...
  './css/thalys.css?v=0520',
  './js/tailwind-config.js?v=015',
  './js/theme-bootstrap.js?v=015',
  './js/config.js?v=0520',
  './js/capabilities.js?v=0520',
  './js/device-media.js?v=0520',
  './js/backend-bridge.js?v=0520',
  './js/server-auth.js?v=0520',
  './js/notifications.js?v=0520',
  './js/storage-manager.js?v=0520',
  './js/sync-queue.js?v=0520',
  './js/conflict-resolver.js?v=0520',
  './js/local-db.js?v=0520',
  './js/ui-foundation.js?v=0520',
  './js/language.js?v=0520',
  './js/drive.js?v=0520',
  './js/auth.js?v=0520',
  './js/app-core.js?v=0520',
  './js/body.js?v=0520',
  './js/meditation.js?v=0520',
  './js/nutrition.js?v=0520',
  './js/workout.js?v=0520',
  './js/home.js?v=0520',
  './js/analytics.js?v=0520',
  './js/oauth-ui.js?v=015',
  './js/media-tools.js?v=025',
  './js/pwa-register.js?v=015',
  './js/app-enhancements.js?v=0520',
  './js/runtime-health.js?v=0520',
